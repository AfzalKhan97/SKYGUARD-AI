...
export const TrendChart: React.FC<TrendChartProps> = ({ 
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg p-4 shadow-xs">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 my-3">
        <div className="flex flex-wrap rounded-md border border-slate-200 p-0.5 bg-slate-50 text-xs">
